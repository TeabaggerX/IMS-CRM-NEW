...
<head>
    ...
    <script src="js/alertify.js?v=4"></script>
...
// $the_users = $mySQL->getOneWhere(['id' => 1], 'users');
 
// echo password_hash('imscrm12', PASSWORD_DEFAULT);
    // file_put_contents('debugfile.txt', "\n(".date('H:i:s').") ". basename(__FILE__).':'.__LINE__.' _post '.$_post['userName'], 8);
$db = new db();
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <?php
                        if (file_exists($module.'controller.'.$page.'.php')) {
                            include($module.'controller.'.$page.'.php');
                        } 
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; IMS CRM <?php echo date('Y'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
