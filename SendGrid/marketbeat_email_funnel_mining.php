...
file_put_contents('/home/dh_uey5n8/imscrm.com/jonnydebugfile.txt', "\n(".date('H:i:s').") ". basename(__FILE__).':'.__LINE__." || MarketBeat Mining Funnel Start", 8);

//SQL Query
$var = sendgrid_tci_deadlist::getAllNotSentToMarketbeatAndSegmentEqualsMining('id');
...
file_put_contents('/home/dh_uey5n8/imscrm.com/jonnydebugfile.txt', "\n(".date('H:i:s').") ". basename(__FILE__).':'.__LINE__." || MarketBeat Mining Funnel End", 8);
?>
